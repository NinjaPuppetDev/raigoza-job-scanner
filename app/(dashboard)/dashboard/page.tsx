...
import {
  Briefcase, CalendarDays, Search, Plus, TrendingUp,
  MoreHorizontal, CheckCircle2, Activity,
} from 'lucide-react';
import {
...
export default function Dashboard() {
  ...
  if (!d) {
    return <div className="content">Couldn&apos;t load your dashboard. Try refreshing.</div>;
  }
    ...
    return (
      <>
        <div className="content" style={{ textAlign: 'center', padding: '80px 0' }}>
          ...
          <p>Add your first one to see the funnel and timeline populate.</p>
          <button className="btn-primary" onClick={() => setShowModal(true)}>
            <Plus size={15} /> Add Application
          </button>
        </div>
        {showModal && <AddApplicationModal onClose={() => setShowModal(false)} onSaved={load} />}
      </>
    );
  }
